function n00_make_brain_region_timelapse(electrode_table, plot_parameters)

timelapse_parameters = plot_parameters.timelapse_parameters;

timelapse_duration = timelapse_parameters.timelapse_duration;
...
timeline_info      = timelapse_parameters.timeline_info;
...
frame_delay_time = timelapse_duration / (n_time_points - 1);
...
if ~no_start_frame
    ...
    switch start_mode
        case 'region_colors'
            ...
            n00_plot_all_electrodes_by_region(electrode_table, plot_parameters);
    end
...
for tdx = 1:n_time_points
    ...
    temp_table = electrode_table(electrode_table.value == tdx, :);
    
    n00_plot_frame(temp_table, plot_parameters);
