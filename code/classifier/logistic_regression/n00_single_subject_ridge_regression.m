...
%%% and a list of groups (partitions) to train ridge regression
%%% classifier. Returns classifier results.

function classifier_results = n00_single_subject_ridge_regression(varargin)
if isempty(varargin)
    classes = [];
    features = [];
    groups = [];
...
classifier_results.regularization = 2;
