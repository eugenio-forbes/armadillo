%%% This function plots classification probability changes and t-statistics
%%% comparing stimulation events to sham for each combination of stimulation parameters.
...
subplot_parameters.colorbar_xs    = [n_xs + .5, n_xs + 1.5];
